...
export default function ProductImageGallery({ product }: ProductImageGalleryProps) {
  ...
  if (!product.images || product.images.length === 0) {
    return (
      <div className="h-[500px] bg-gradient-to-br from-slate-100 to-slate-200 rounded-3xl flex items-center justify-center shadow-inner">
        <div className="text-center">
          ...
          <span className="text-slate-500 font-medium text-lg">No images available</span>
        </div>
      </div>
    );
  }
